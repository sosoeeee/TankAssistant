...
class Ui_Calculate_Window(object):
    def setupUi(self, Calculate_Window):
        ...
        Calculate_Window.resize(559, 404)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(40, 90, 221, 171))
...
"font: 10pt \"Adobe Heiti Std\";")
        ...
        self.hint.setGeometry(QtCore.QRect(291, 180, 219, 80))
...
"font: 9pt \"Adobe Heiti Std\";")
        ...
        self.label_10.setGeometry(QtCore.QRect(290, 97, 77, 29))
        self.label_10.setStyleSheet("font: 14pt \"Adobe Heiti Std\";")
        self.label_10.setAlignment(QtCore.Qt.AlignCenter)
        self.label_10.setObjectName("label_10")
        self.power = QtWidgets.QTextBrowser(self.centralwidget)
        self.power.setGeometry(QtCore.QRect(376, 92, 133, 37))
        self.power.setObjectName("power")
        self.angle = QtWidgets.QTextBrowser(self.centralwidget)
        self.angle.setGeometry(QtCore.QRect(376, 136, 133, 37))
        self.angle.setObjectName("angle")
        self.label_11 = QtWidgets.QLabel(self.centralwidget)
        self.label_11.setGeometry(QtCore.QRect(292, 139, 71, 29))
        ...
        self.predict.setGeometry(QtCore.QRect(280, 282, 231, 28))
        self.predict.setObjectName("predict")
        self.collect = QtWidgets.QPushButton(self.centralwidget)
        self.collect.setGeometry(QtCore.QRect(42, 282, 231, 28))
    ...
    def retranslateUi(self, Calculate_Window):
        ...
        self.wind_power_label.setText(_translate("Calculate_Window", "WindPower"))
